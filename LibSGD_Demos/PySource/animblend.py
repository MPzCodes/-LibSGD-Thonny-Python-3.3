...
#
# Version 0.1, show to use anime with blend effects between movings
...
# window
sgd.createWindow(800, 600, "animblend", 0)
sgd.setClearColor(0.1,0.2,0.3,1)
...
model = sgd.loadBonedModel("../assets/models/base_male_animated.glb",True)
