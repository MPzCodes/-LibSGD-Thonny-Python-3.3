...
#
# Version 0.1, show some cubes in a 3d Space, with moving and shooting
...
def resetScene():
    ...
    bulletImage = sgd.loadImage("../assets/misc/light.png")

    slimeBall = sgd.loadSound("../assets/audio/slimeball.wav")

    # Create ground model

    material = sgd.loadPBRMaterial("../assets/materials/Gravel023_1K-JPG")
    ...
    material = sgd.loadPBRMaterial("../assets/materials/Fabric048_1K-JPG")
